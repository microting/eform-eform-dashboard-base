...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormDashboardBase/Microting.eFormDashboardBase.csproj package Microting.eForm
	dotnet add Microting.eFormDashboardBase/Microting.eFormDashboardBase.csproj package Microting.eFormApi.BasePn
